...
export default function MainContent({ response }: MainContentProps) {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="my-3 h-12 w-full">
          <Form className="w-full flex items-center justify-start" method="post">
            ...
            />
            <Button type="submit" variant={"destructive"} className="ms-2 bg-teal-500 w-32" name="_action" value={"query"}>
              <Play />
              Run Query
            </Button>
          </Form>
        ...
        {/* AI Response */}
        {((response && response.type === "ai") || isAiLoading) && (
